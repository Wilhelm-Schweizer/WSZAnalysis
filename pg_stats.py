...
class MyApp1(QMainWindow, Ui_portfolio_divs): #gui class
    def __init__(self,stats):
        ...
        df_ges = df_ges.groupby('Periode')['EUR_sum'].sum().reset_index()
        ...
        self.val_4.setText(str(round(df_pr['EUR_sum'].sum())) + ' EUR')
        self.val_7.setText(str(round(df_pa['EUR_sum'].sum())) + ' EUR')
        self.val_8.setText(str(round(df_ges['EUR_sum'].sum())) + ' EUR')
        self.val_2.setText(str(round(df_pr['EUR_sum'].mean())) + ' EUR')
        self.label_2.setText(str(round(df_pa['EUR_sum'].mean())) + ' EUR')
        self.val_6.setText(str(round(df_ges['EUR_sum'].mean())) + ' EUR')
        self.val_3.setText(str(round(df_pr['EUR_sum'].sum()/(df_pr['EUR_sum'].sum() + df_pa['EUR_sum'].sum())*100)) + ' %')
        self.label_3.setText(str(round(df_pa['EUR_sum'].sum()/(df_pr['EUR_sum'].sum() + df_pa['EUR_sum'].sum())*100)) + ' %')
